...
The unofficial due date is 4/11 to keep you on track, however feel free to use more time to complete the lab as needed.
As follows, the lab is worth 0 points.

There **will be lab sections** for this week.
...
The Gradescope autograder is not comprehensive. However, you can make sure your game works by checking the following: 
