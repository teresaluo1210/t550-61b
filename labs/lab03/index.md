...
You should not need to edit handleResponses.
...
To find the bugs, you should not need to step into the `mysteryMax` or `mysteryAdd`
functions, or even understand what they are doing. That is, you should
...
result. If you find a bug in `mysteryMax` or `mysteryAdd`, rewrite the faulty method entirely
