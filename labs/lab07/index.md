...
the performance of `MyHashMap` when it uses different data structures as the
buckets.
...
(optional for Lab 07). For these, feel free to throw an
...
- Lecture slides:
  - [Lecture 19](https://docs.google.com/presentation/d/1JelUuuXlyeHQam1UDOamQdkOucFj_vCI5bNZWFkhTuM/edit#slide=id.g1f6a0dff07b_0_1266)
  - [Lecture 20](https://docs.google.com/presentation/d/1SNMyAbboJ5ArhN9WmkaeOgFrMJUWFbcZn2hbTSWGcuY/edit#slide=id.g1f6a0dff07b_0_1266)
